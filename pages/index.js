        ...
        <Container className="mw-1200">
          <Row>
            <Col sm={12} lg={6}>
              ...
              <p>
                От област Хасково само Детска градина № 4 е включена в
                Национална програма за превенция на хроничните незаразни болести
                2014-2020 г. В рамките на програмата ще се проведе национално
                изследване на риска за здравето, с цел да се установи нивото на
                разпространение на рискови фактори.
              </p>
            </Col>
            <Col sm={12} lg={6}>
              <Row>
