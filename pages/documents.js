            ...
            <Container>
                <Row>
                    ...
                    <Col sm={12} md={4}>
                        ...
                        <ul>
                            <li>
                                <a href="/files/obshtestven_suvet/pravilnik_obshtestvena_info.pdf" target="_blank">Правилник за достъп до обществена информация</a>
                            </li>
                            <li>
                                <a href="/files/obshtestven_suvet/pravilnik_deinost.pdf" target="_blank">Правилник за дейността на ОС</a>
                            </li>
                            <li>
